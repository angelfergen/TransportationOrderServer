...
public class TransportationOrder {  
    ...
    public TransportationOrder(final String toid, final String truck, final long originDate,

                               final double originLat, final double originLong,

                               final long dstDate, final double dstLat, final double dstLong,

                               final long lastDate, final double lastLat, final double lastLong,
